...
def step_decay(epoch):
    ...
    if epoch < 30: lr = 0.0001
    elif epoch >= 30 and epoch < 50 : lr = 0.00009
    elif epoch >= 50 and epoch < 70: lr = 0.00008
    elif epoch >= 70 and epoch < 100: lr = 0.00005
    elif epoch >= 100: lr = 0.00002
...
def step_decay(epoch):
    lr = 0.01
    if epoch < 30: lr = 0.01
    elif epoch >= 30 and epoch < 50 : lr = 0.009
    elif epoch >= 50 and epoch < 70: lr = 0.008
    elif epoch >= 70 and epoch < 100: lr = 0.005
    elif epoch >= 100: lr = 0.002
